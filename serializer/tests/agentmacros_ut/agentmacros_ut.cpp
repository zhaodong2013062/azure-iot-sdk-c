...
AGENT_DATA_TYPES_RESULT Create_AGENT_DATA_TYPE_from_charz_secret(AGENT_DATA_TYPE*, const char*) { return AGENT_DATA_TYPES_ERROR; }
AGENT_DATA_TYPES_RESULT Create_AGENT_DATA_TYPE_from_EDM_TIMESPAN(AGENT_DATA_TYPE*, EDM_TIMESPAN) { return AGENT_DATA_TYPES_ERROR; }
AGENT_DATA_TYPES_RESULT Create_AGENT_DATA_TYPE_from_EDM_DURATION(AGENT_DATA_TYPE*, EDM_DURATION) { return AGENT_DATA_TYPES_ERROR; }
AGENT_DATA_TYPES_RESULT Create_AGENT_DATA_TYPE_from_EDM_GEOGRAPHY_POINT(AGENT_DATA_TYPE*, EDM_GEOGRAPHY_POINT) { return AGENT_DATA_TYPES_ERROR; }
