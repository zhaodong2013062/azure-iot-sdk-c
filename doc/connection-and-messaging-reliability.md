...
3. The `transport protocol` then creates:
   ...
   * A `tlsio_*` instance based on the system where it is running (by default schannel on Windows and openssl on Linux), and
...
In [iothub_client module](https://github.com/Azure/azure-iot-sdk-c/blob/2018-05-04/iothub_client/inc/iothub_client.h#L188):
...
Or if using the [iothub_client_ll module](https://github.com/Azure/azure-iot-sdk-c/blob/2018-05-04/iothub_client/inc/iothub_client_ll.h#L419):
...
|-|-|-|
|IOTHUB_CLIENT_RETRY_NONE|No re-connections are ever attempted.</br></br>Usually this option is used along with Connection Status callbacks by users that want to implement their own connection retry logic (at the application layer).|Device client detects a connection issue, but it never attempts to reconnect.|
...
On [iothub_client](https://github.com/Azure/azure-iot-sdk-c/blob/2018-05-04/iothub_client/inc/iothub_client.h#L171) module:
